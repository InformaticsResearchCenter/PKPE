...
\title{Panduan Keahlian\\[1ex]     %your thesis title,
        Penanganan \textit{Error} }   %note \\[1ex] is a line break in the title

\author{\begin{tabular}[t]{l@{\extracolsep{5em}}l} 
Rolly Maulana Awangga  & \textbf{github.com/awangga} \\
Syafrial Fachri Pane & \textbf{github.com/fachrie007} \\
M. Innal Kariem & \textbf{github.com/karieminnal}\\ 
Rayhan Prastya& \textbf{github.com/rayprastya}\\
Idam Fadilah & \textbf{github.com/idamfadilah}
\end{tabular}
}             %your name
